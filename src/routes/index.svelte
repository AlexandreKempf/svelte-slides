...
<Deck>
	...
	<Slide>
		<div
			class="flex flex-wrap justify-around items-center mx-auto max-w-22/24 pt-20"
		>
	...
	<Slide>
		<div class="flex flex-wrap justify-around mx-auto max-w-22/24 pt-20">
			...
			<div class="xl:w-11/24 w-22/24">
				<div
					class="flex flex-wrap justify-around items-top mx-auto max-w-22/24"
				>
	...
	<Slide>
		<div class="flex flex-col min-h-screen pt-20 ml-8">
			<p
				class="font-sans font-bold text-sm text-blue-600 tracking-widest uppercase"
			>
				your tagline
